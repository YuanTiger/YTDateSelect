...
public class YTDateUtils {
    ...
    public static ArrayList<MonthBean> createMonthBean(int startYear, int endYear) {
        return createMonthBean(startYear, 1, endYear, 12);
    }
     ...
     * @return
     */
    public static ArrayList<MonthBean> createMonthBean(int startYear, int startMonth, int endYear, int endMonth) {

        return createMonthBean(startYear, startMonth, 1, endYear, endMonth, getDayCountOfMonth(endYear, endMonth));
    }
     ...
     * @return
     */
    public static ArrayList<MonthBean> createMonthBean(int startYear, int startMonth, int startDay, int endYear, int endMonth, int endDay) {
        ...
        ArrayList<MonthBean> data = new ArrayList<>();
        //如果数据在同一年内
        if (startYear == endYear) {
            for (int currentMonth = startMonth; currentMonth <= endMonth; currentMonth++) {
                if (currentMonth == startMonth) {
                    data.add(new MonthBean(startYear, currentMonth, startDay));
                } else {
